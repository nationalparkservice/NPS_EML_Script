...
Created By: Judd Patterson by [judd_patterson@nps.gov](mailto:judd_patterson@nps.gov?Subject=NPS EML Template)
Last Updated: `r Sys.Date()` by Rob Baker [robert_baker@nps.gov](mailto:robert_baker@nps.gov?Subject=NPS EML Template)

# Before you start
## Install required software & packages
You will need to install R and will find RStudio very helpful. Both can be installed from Software Center without need for admin rights on your machine. For more information, see the R Advisory Group's [website](https://doimspp.sharepoint.com/sites/nps-nrss-imdiv/SitePages/R-Adv.aspx).
...
## Provide some information about the data package as a whole:
...
# Once you've generated valid EML metadata
