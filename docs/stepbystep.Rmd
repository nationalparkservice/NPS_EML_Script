...
Created By: Judd Patterson by [judd_patterson@nps.gov](mailto:judd_patterson@nps.gov)
Last Updated: `r Sys.Date()` by Rob Baker (robert_baker@nps.gov)(mailto:robert_baker@nps.gov)
