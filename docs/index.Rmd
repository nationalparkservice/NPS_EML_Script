...
You can also directly access the [source files](https://github.com/nationalparkservice/NPS_EML_Template) for this webpage and the entire repo, as well as download the entire repo as [zip file](https://github.com/nationalparkservice/NPS_EML_Templat/zipball/master).
