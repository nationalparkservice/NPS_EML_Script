...
# data packages. This workflow takes advantage of existing EML creation tools
# such as the R packages EMLassemblyline and EML. However, these tools were not
# designed to work with DataStore. Therefore, the workflow also incorporates
