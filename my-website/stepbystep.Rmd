...
You **must edit** the "intellectual_rights.txt" file:
  ...
  *   If you have CUI, replace the CC0 license with the following text:
...
```
  ...
  * If you have no CUI you can choose one of two options, both of which mean there are no licenses, copyrights, or restrictions on use or re-use of the data. The CC0 license makes the free use of the data explicit and is recognized globally whereas for works in the public domain the lack of restrictions is implicit and may be subject to local jurisdiction. Replace the text in the license.txt file with one of the following:
  ...
  > This product is released to the "public domain" under U.S. Government Works "No Rights Reserved (see: http://www.usa.gov/publicdomain/label/1.0/).
  
  * If you need a license, for instance because the data were generated by non-NPS contractors or in collaboration with non-NPS partners, use the CC0 license.
