...
#Vector of dataset file names. Tell EMLassemblyline what the names of your data files are. Watch out for spelling and case.  
data_files <- c("qry_Export_AA_Points.csv", "qry_Export_AA_VegetationDetail.csv")

#If the only .csv files in your working_folder are datafiles for your data package, you could instead use:
