...
The first set of steps involves inputing information about your data package. The second set of steps ("EMLassemblyline Functions") is a step by step process where each section should be reviewed and edited if necessary, and run one by one. Not all of the functions apply to all data packages. The EMLassemblyline functions will generate .txt files that need to be manually edited. 
